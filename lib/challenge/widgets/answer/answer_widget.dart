        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                //utiliza a área disponível, expandindo e quebrando a linha
                Expanded(
                  child: Text(
                    answer.title,
                    style: isSelected
                ...
                //cria um conteiner próprio para a seleção e icone
                Container(
                  width: 24,
                  height: 24,
                  decoration: BoxDecoration(
                      color: isSelected ? _selectedColorRight : AppColors.white,
                      //deixar circular o conteiner
                  ...
                  child: isSelected
                      ? Icon(_selectedIconRight, color: Colors.white, size: 16)
                      : null,
                )
              ],
            ),
